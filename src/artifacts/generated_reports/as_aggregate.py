...
class AggregateReport:
  ...
  def update(self):
    ...
    row_defs = [
      ...
      ["Dorm Beds", num_dorm_beds_booked, 332, "%.02f%%" % (100 * num_dorm_beds_booked/332.0)],
      ["Kitchenette Bedrooms", num_apt1_beds_booked, 114, "%.02f%%" % (100 * num_apt1_beds_booked/114.0)],
      ["Kitchen Bedrooms", num_apt2_beds_booked, 158, "%.02f%%" % (100 * num_apt2_beds_booked/158.0)],
